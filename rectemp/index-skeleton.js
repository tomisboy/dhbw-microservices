...
var client  = mqtt.connect('mqtt://test.mosquitto.org',{clientId:"rectemp-hsMQu1111hewiuhewuTT"});
...
function mqtt_messsageReceived(topic, message, packet)
{
    ...
    case 'T':{
        ...
        if (value > 19)
        {
            console.log("Schwellwert für Temperatur erreicht");
            console.log(value + "<--")
    ...
    case 'X':{
        ...
        if (value > 2000)
        {
            console.log("Schwellwert für Co2 erreicht");
            console.log(value + "<--")
    ...
    case 'P':{
        ...
        if (value > 20)
        {
            console.log("Schwellwert für Personen erreicht");
            console.log(value + "<--")
    ...
    case 'H':{
        ...
        if (value > 60)
        {
            console.log("Schwellwert für relativer Luftfeuchtigkeit erreicht");
            console.log(value + "<--")
    ...
    case 'p':{
        ...
        if (value > 5)
        {
            console.log("Schwellwert für Feinstaub erreicht");
            console.log(value + "<--")
